...
export default function Demo() {
  return (
    <div className="py-7 relative ">
      ...
      <div className="flex justify-items-center  px-6 gap-5 justify-center">
        <div>
          <img
            src="macbook.png"
      ...
      <div className="">
      <svg className="absolute bottom-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#FFDEE1" fill-opacity="1" d="M0,192L1440,288L1440,320L0,320Z"></path></svg>
      </div>
    </div>
  );
}
