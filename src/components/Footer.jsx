...
export default function Footer() {
    ...
    <footer className="bg-[#004542]">
      <div className="">
        <div className="flex justify-center py-6">
          <img
            className="lg:h-[132px] lg:absolute h-[60px] "
            src="tracebale.png"
          />
        </div>
  ...
  {/**information center */}
        ...
        <div className="flex lg:flex-row flex-col lg:gap-0 gap-3 py-6 px-6 justify-between text-white items-center">
          ...
          <div className=" ">
            <p className=" text-[#B1D2C5]">Designed by:</p>
            <div className="flex">
              <img src="rock.png" />
              <img src="rock3.png" />
              <img src="rock2.png" />
